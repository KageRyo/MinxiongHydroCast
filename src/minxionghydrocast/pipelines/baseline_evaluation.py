...
from minxionghydrocast.models.evaluation import evaluate_all, write_evaluation_result

PIPELINE_NAME = "baseline_evaluation"


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate MinxiongHydroCast baseline models.")
    parser.add_argument(
        "--events",
        type=Path,
