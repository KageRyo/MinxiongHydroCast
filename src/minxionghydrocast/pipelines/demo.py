...
from minxionghydrocast.ingestion.hydrological_data import run_demo as run_hydrology_demo
from minxionghydrocast.ingestion.rainfall_alerts import run as run_rainfall_alerts
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the local MinxiongHydroCast demo pipeline.")
