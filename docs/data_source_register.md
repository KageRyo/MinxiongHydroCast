...
| CWA file/history APIs | CWA | Radar/QPE discovery and event archives | API key | Dataset construction | Pending model-distribution rights review |
...
- approved operational and data-model uses.
